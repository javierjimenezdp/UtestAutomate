...
public class UtestSteps  {
   ...
   public void enterPageUtest(){
    ...
    public void enterPassword(String password, String comfirmPassword) {
        utestPageObject.setPassword(password);
        utestPageObject.setConfirmPassword(comfirmPassword);
    }
    public void cliclCheckBox() {
        utestPageObject.cliclCheckBox1();
        utestPageObject.clickCheckBox2();
        utestPageObject.clickCheckBox3();
        utestPageObject.clickNextPage4();
    }
    public void seCompletaElRegistroDeManeraExitosaPage4() {
        utestPageObject.verificationLogin();
    }
